  ...
  return (
    <section className="max-w-7xl mx-auto mb-14">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="w-full md:w-[60%] md:mb-0 bg-cream md:min-h-[700px] relative">
          ...
          <div className="md:px-20 px-4 pt-2 md:pb-0 pb-8 space-y-5">
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="text-center md:text-left border-l-2 border-secondary pl-4"
                >
        ...
        <div className="hidden md:block h-[700px] w-[40%] absolute right-[120px]">
          <Image
            src={image}
