...
import image from "../../../public/images/tribhuvan/super-deluxe-room.jpeg";
...
export default function AboutBanner() {
  return (
    <section className="relative w-full h-[260px] sm:h-[320px] md:h-[400px]">
      <Image
        src={image}
        alt="A spacious, well-appointed room at The Tribhuvan Residency in Ayodhya"
        fill
